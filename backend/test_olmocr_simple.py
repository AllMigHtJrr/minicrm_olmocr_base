#!/usr/bin/env python3
"""
Simple OLM OCR Test Script
Tests the corrected OLM OCR implementation
"""
...
def test_model_loading():
    ...
    try:
        ...
        model, tokenizer = load_olmocr_model()
...
def test_image_processing():
    ...
    try:
        from utils import preprocess_image, encode_image_to_base64
        ...
        # Convert to PIL and test base64 encoding
...
def main():
    """Run all tests"""
    logger.info("🧪 Starting OLM OCR Tests...")
    logger.info("=" * 50)
    ...
    if passed == total:
        logger.info("🎉 All tests passed! OLM OCR is working correctly.")
        return True
    else:
